...
```
```dashboard:open-url
url: https://simple-app-{{ session_namespace }}.{{ ENV_TAP_INGRESS }}
```
...
```dashboard:open-url
url: https://cartographer.sh/docs/v0.7.0/reference/deliverable/
```
```dashboard:open-url
url: https://cartographer.sh/docs/v0.7.0/reference/template/#clusterdeploymenttemplate
```
